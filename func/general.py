...
from func.google_utils import gsutil_getsize
from func.metrics import fitness
from func.torch_utils import init_torch_seeds
...
def one_cycle(y1=0.0, y2=1.0, steps=100):
    # lambda func for sinusoidal ramp from y1 to y2
...
def strip_optimizer(f='weights/best.pt', s=''):  # from func.general import *; strip_optimizer()
