...
class CamConfig:
    def __init__(self):
        ...
        self.v_timer = QTimer()
        # 打开摄像头
        url = 'https://121.10.141.83:21313/video_feed'
    ...
    def show_pic(self):
        # 全局变量
        # 在函数中引入定义的全局变量
        global EYE_AR_THRESH,EYE_AR_CONSEC_FRAMES,MAR_THRESH,MOUTH_AR_CONSEC_FRAMES,COUNTER,TOTAL,mCOUNTER,mTOTAL,ActionCOUNTER,Roll,Rolleye,Rollmouth,statu,action
        ...
        # with open('C:\\Users\\Administrator\\Desktop\\driver_detector\\module 1\\Yolov5-deepsort-driverDistracted-driving-behavior-detection\\photo\\photo.jpg','rb') as f:
        #     img=Image.open(f)
        # frame=np.array(img)
        success, frame = self.cap.read()
        if success:
